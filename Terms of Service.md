...
#   
1. Users must not intentionally spam, crash, overload, or otherwise misuse the bot. Any servers or users found to be doing this can be blacklisted from using certain commands or all commands at the discretion of the bot owner
